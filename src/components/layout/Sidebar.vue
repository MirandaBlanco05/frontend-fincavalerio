<template>
  <aside class="fixed left-0 top-0 z-50 hidden h-full w-64 flex-col gap-4 bg-[#1f241a] p-4 shadow-xl lg:flex font-display">
    ...
    <!-- Brand -->
    <div class="flex items-center gap-3 px-2 py-4 border-b border-white/10">
    ...
    <ul class="flex flex-col gap-1">
      ...
      <li class="flex h-12 items-center gap-4 rounded-lg px-4 opacity-30 cursor-not-allowed">
        <span class="material-symbols-outlined text-white/60">favorite</span>
        <p class="text-sm font-bold text-white/80">Reproducción</p>
      </li>
