        ...
        <div class="flex w-full flex-col rounded-t-xl bg-white sm:max-w-md sm:rounded-xl overflow-hidden shadow-2xl">
          ...
          <div class="flex items-center justify-between p-6 border-b border-gray-100">
            <div>
              ...
              <p class="text-xs text-gray-500 font-medium">Gestión de protocolos médicos</p>
            </div>
          ...
          <div class="flex flex-col gap-6 p-6">
            ...
            <div class="space-y-2">
              <label class="text-xs font-bold text-gray-700 uppercase tracking-wider">Enfermedad Relacionada</label>
            ...
            <div class="space-y-2">
              <label class="text-xs font-bold text-gray-700 uppercase tracking-wider">Veterinario / Empleado</label>
