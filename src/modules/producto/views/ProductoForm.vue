    ...
    <div class="modal-content">
      ...
      <div class="modal-header">
        <div>
          ...
          <p class="modal-subtitle">Complete los detalles del producto</p>
        </div>
      ...
      <form @submit.prevent="guardar" class="modal-body">
        ...
        <div class="form-group">
          ...
          <input
            ...
            required
            class="form-input"
            placeholder="Ej: Leche Fresca 1L"
          />
        </div>
        ...
        <div class="modal-footer">
          <button type="button" @click="router.push({ name: 'Productos' })" class="btn btn--secondary">
            Cancelar
          </button>
...
onMounted(async () => {
  ...
  if (modoEdicion.value) {
    ...
    if (prod) {
      ...
      errorLocal.value = 'No se pudo encontrar el producto.'
    }
  }
})
...
async function guardar() {
  ...
  try {
    ...
    let result
    if (modoEdicion.value) {
      result = await store.actualizarProducto(route.params.id, payload)
    } else {
      result = await store.crearProducto(payload)
    }

    if (result && result.success) {
      router.push({ name: 'Productos' })
    } else {
      errorLocal.value = store.error || 'Error al guardar el producto'
    }
